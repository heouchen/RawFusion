...
class RefineNet(nn.Module):
    def __init__(self, img_channels=4):
        ...
        self.conv1 = nn.Sequential(DeformConvRelu(img_channels+2+2+1+1+3, c1), convrelu(c1, c1))
...
class SAFNet_Opt_V2(nn.Module):
    def __init__(self):
        super(SAFNet_Opt_V2, self).__init__()
...
if __name__ == "__main__":
    ...
    modelviz = SAFNet_Opt_V2().to(device)
