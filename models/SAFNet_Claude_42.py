"""
SAFNet_Claude_42 — Claude_40 with Lightweight Refine-Side Frequency Gating
==========================================================================
Built on SAFNet_Claude_40 with a single low-risk addition from Claude_36:
1. Keep input grouping, alignment, reliable merge, and high-resolution tail unchanged.
2. Add a lightweight frequency-aware gate before the RefineNet residual block stack.
3. Preserve the existing RepDWConv deployment-time reparameterization path.
...
# ======================== SAFNet_Claude_42 ========================
class SAFNet_Claude_42(nn.Module):
    def __init__(self):
        super().__init__()
...
def _print_profile(height=384, width=768, params_cap_m=5.0, flops_cap_g=100.0):
    ...
    model_before = SAFNet_Claude_42().to(device).eval()
