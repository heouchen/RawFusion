"""
SAFNet_Claude_32 — Hybrid CondConv + Pyramid Reshaping (Fixed)
==============================================================
Fixed version with:
1. Correct P1 stride=2 (half-resolution first stage)
2. Restored 2-pass coarse-to-fine flow estimation
3. Proper LearnedMerge3Frame (2 blocks + attn_head with softmax)
4. RefineNet with 5 symmetric-dilation blocks
5. Encoder [48, 48, 48, 96] with CondConv at P4 (24 experts)
6. 2 decoders: shared DecoderDCN(48) for L1-L3, DecoderDCN(96) for L4
   with CondConv (12 experts) in decoder blocks for param target

Constraints: ~4.2M params, ~98G MACs.
"""
import numpy as np
import torch
...
class DecoderDCN(nn.Module):
    def __init__(self, in_channels=48):
        ...
        self.blocks = nn.Sequential(
            RepNeXtBlock(96, cond=True, num_experts=12),
            RepNeXtBlock(96, cond=True, num_experts=12),
        )
...
# ======================== SAFNet_Claude_32 ========================
class SAFNet_Claude_32(nn.Module):
    def __init__(self):
        super().__init__()
        self.encoder = Encoder()
        self.decoder_low = DecoderDCN(48)
        self.decoder_high = DecoderDCN(96)
    ...
    def forward_flow_mask(self, img0_c, img4_c, img8_c, scale_factor=0.5):
        ...
        # Pass 1: coarse flow from original features
        up_flow0_4, up_flow8_4, up_mask0_4, up_mask8_4 = self.decoder_high(
            f0_4, f4_4, f8_4, up_flow0_5, up_flow8_5, up_mask0_5, up_mask8_5)
        up_flow0_3, up_flow8_3, up_mask0_3, up_mask8_3 = self.decoder_low(
            f0_3, f4_3, f8_3, up_flow0_4, up_flow8_4, up_mask0_4, up_mask8_4)
        up_flow0_2, up_flow8_2, up_mask0_2, up_mask8_2 = self.decoder_low(
            f0_2, f4_2, f8_2, up_flow0_3, up_flow8_3, up_mask0_3, up_mask8_3)
        up_flow0_1, up_flow8_1, up_mask0_1, up_mask8_1 = self.decoder_low(
            f0_1, f4_1, f8_1, up_flow0_2, up_flow8_2, up_mask0_2, up_mask8_2)

        # Warp images with coarse flow, re-encode
        ...
        # Pass 2: residual flow from warped features
        up_rflow0_4, up_rflow8_4, up_rmask0_4, up_rmask8_4 = self.decoder_high(
            f0w_4, f4_4, f8w_4, up_rflow0_5, up_rflow8_5, up_rmask0_5, up_rmask8_5)
        up_rflow0_3, up_rflow8_3, up_rmask0_3, up_rmask8_3 = self.decoder_low(
            f0w_3, f4_3, f8w_3, up_rflow0_4, up_rflow8_4, up_rmask0_4, up_rmask8_4)
        up_rflow0_2, up_rflow8_2, up_rmask0_2, up_rmask8_2 = self.decoder_low(
            f0w_2, f4_2, f8w_2, up_rflow0_3, up_rflow8_3, up_rmask0_3, up_rmask8_3)
        up_rflow0_1, up_rflow8_1, up_rmask0_1, up_rmask8_1 = self.decoder_low(
