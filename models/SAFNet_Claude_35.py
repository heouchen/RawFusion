"""
SAFNet_Claude_35 — Feature-Reuse Two-Stage + Partially-Decoupled Decoder
=========================================================================
Built on SAFNet_Claude_34, integrating practical budget-aware upgrades:
1. Stage-2 flow refinement reuses stage-1 encoder features (no second full re-encode).
2. Stage-2 decoders are partially decoupled at low-resolution levels (L4/L3).
3. Keep large-kernel reparameterizable blocks (RepDWConvS/M/L) for deploy-time fusion.
...
# ======================== SAFNet_Claude_35 ========================
class SAFNet_Claude_35(nn.Module):
    def __init__(self):
        super().__init__()
