"""
SAFNet_Claude_19 — 5-Frame 2-Pass Iterative + Lite RefineNet (48ch)
=====================================================================
Based on Claude_17:
  1) Keeps 5-frame 2-pass iterative flow estimation (9 enc + 16 dec)
  2) Reduces post-processing channels to cut compute:
     - RefineNet channels: c0=12, c1=24, c2=12 (total 48)
     - HybridBlock expand_ratio=2 (unchanged)

Goal: preserve alignment quality while reducing post-fusion cost.
"""
import numpy as np
import torch
...
class RefineNetLite19(nn.Module):
    """48-channel post-process head."""
...
class SAFNet_Claude_19(nn.Module):
    def __init__(self):
        super().__init__()
        self.encoder = Encoder()
        self.decoder = DecoderDCN()
        self.refinenet = RefineNetLite19()
...
if __name__ == "__main__":
    ...
    model = SAFNet_Claude_19().to(device)
