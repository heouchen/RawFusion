"""
SAFNet_Claude_20 — 5-Frame 2-Pass Iterative + UltraLite RefineNet (40ch)
==========================================================================
Based on Claude_17:
  1) Keeps 5-frame 2-pass iterative flow estimation (9 enc + 16 dec)
  2) More aggressive post-processing reduction:
     - RefineNet channels: c0=10, c1=20, c2=10 (total 40)
     - HybridBlock expand_ratio=1 in RefineNet blocks

Goal: maximize efficiency while preserving robust 5-frame motion alignment.
"""
import numpy as np
import torch
...
class RefineNetLite20(nn.Module):
    """40-channel post-process head, with lighter HybridBlock expansion."""
...
class SAFNet_Claude_20(nn.Module):
    ...
    def forward_flow_mask(self, img0_c, img2_c, img4_c, img6_c, img8_c,
        ...
        a_f0_4, a_f8_4, a_m0_4, a_m8_4 = self.decoder(f0_4, f4_4, f8_4, zf, zf, zm, zm)
        a_f0_3, a_f8_3, a_m0_3, a_m8_3 = self.decoder(f0_3, f4_3, f8_3, a_f0_4, a_f8_4, a_m0_4, a_m8_4)
        a_f0_2, a_f8_2, a_m0_2, a_m8_2 = self.decoder(f0_2, f4_2, f8_2, a_f0_3, a_f8_3, a_m0_3, a_m8_3)
        a_f0_1, a_f8_1, a_m0_1, a_m8_1 = self.decoder(f0_1, f4_1, f8_1, a_f0_2, a_f8_2, a_m0_2, a_m8_2)

        b_f2_4, b_f6_4, b_m2_4, b_m6_4 = self.decoder(f2_4, f4_4, f6_4, zf, zf, zm, zm)
        b_f2_3, b_f6_3, b_m2_3, b_m6_3 = self.decoder(f2_3, f4_3, f6_3, b_f2_4, b_f6_4, b_m2_4, b_m6_4)
        b_f2_2, b_f6_2, b_m2_2, b_m6_2 = self.decoder(f2_2, f4_2, f6_2, b_f2_3, b_f6_3, b_m2_3, b_m6_3)
        b_f2_1, b_f6_1, b_m2_1, b_m6_1 = self.decoder(f2_1, f4_1, f6_1, b_f2_2, b_f6_2, b_m2_2, b_m6_2)
        ...
        ar_f0_4, ar_f8_4, ar_m0_4, ar_m8_4 = self.decoder(f0w_4, f4_4, f8w_4, zf, zf, zm, zm)
        ar_f0_3, ar_f8_3, ar_m0_3, ar_m8_3 = self.decoder(f0w_3, f4_3, f8w_3, ar_f0_4, ar_f8_4, ar_m0_4, ar_m8_4)
        ar_f0_2, ar_f8_2, ar_m0_2, ar_m8_2 = self.decoder(f0w_2, f4_2, f8w_2, ar_f0_3, ar_f8_3, ar_m0_3, ar_m8_3)
        ar_f0_1, ar_f8_1, ar_m0_1, ar_m8_1 = self.decoder(f0w_1, f4_1, f8w_1, ar_f0_2, ar_f8_2, ar_m0_2, ar_m8_2)

        br_f2_4, br_f6_4, br_m2_4, br_m6_4 = self.decoder(f2w_4, f4_4, f6w_4, zf, zf, zm, zm)
        br_f2_3, br_f6_3, br_m2_3, br_m6_3 = self.decoder(f2w_3, f4_3, f6w_3, br_f2_4, br_f6_4, br_m2_4, br_m6_4)
        br_f2_2, br_f6_2, br_m2_2, br_m6_2 = self.decoder(f2w_2, f4_2, f6w_2, br_f2_3, br_f6_3, br_m2_3, br_m6_3)
        br_f2_1, br_f6_1, br_m2_1, br_m6_1 = self.decoder(f2w_1, f4_1, f6w_1, br_f2_2, br_f6_2, br_m2_2, br_m6_2)
...
if __name__ == "__main__":
    ...
    model = SAFNet_Claude_20().to(device)
