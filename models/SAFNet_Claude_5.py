"""
SAFNet_Claude_5 — Best-of-All: 5-Frame + HybridBlock (DW-Sep + SE)
====================================================================
Combines the strongest ideas from Claude_1 through Claude_4:
  1. 5-frame utilization (frames 0,2,4,6,8) → better SNR (from Claude_3)
  2. Depthwise separable inverted bottleneck → FLOPs-efficient width (from Claude_2)
  3. SE channel attention → adaptive feature selection (from Claude_1)
  4. GELU activation + learnable residual scaling → stable deep training
  5. 72ch RefineNet with 8 HybridBlocks → more capacity within budget

Encoder/Decoder: identical to V2 (proven alignment)
"""
import numpy as np
import torch
...
# ======================== SAFNet_Claude_5 ========================
class SAFNet_Claude_5(nn.Module):
    def __init__(self):
        super().__init__()
...
if __name__ == "__main__":
    ...
    model = SAFNet_Claude_5().to(device)
