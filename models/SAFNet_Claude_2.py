"""
SAFNet_Claude_2 — NAFNet-Style SimpleGate Blocks
==================================================
Key changes from SAFNet_Opt_V2:
  - Replace ResBlocks with NAFNet-style blocks: inverted bottleneck + DW conv + SimpleGate
  - Depthwise separable convolutions are FLOPs-efficient → can afford 80ch width (vs 48)
  - 10 NAFBlocks (vs 5 ResBlocks) — massively deeper at comparable FLOPs
  - SimpleChannel Attention (SCA) provides adaptive channel reweighting
  - Learnable residual scaling (beta) for stable deep training
  - GroupNorm(1, C) ≈ LayerNorm for better per-sample normalization
...
class RefineNet(nn.Module):
    def __init__(self, img_channels=4):
        ...
        # 10 NAFBlocks with multi-scale dilation
...
# ======================== SAFNet_Claude_2 ========================
class SAFNet_Claude_2(nn.Module):
    def __init__(self):
        super().__init__()
...
if __name__ == "__main__":
    ...
    model = SAFNet_Claude_2().to(device)
